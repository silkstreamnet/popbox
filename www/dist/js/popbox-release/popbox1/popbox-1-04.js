(function($){
	...
	function popboxStart(linkobject,settings)
	{
		...
		$(linkobject).click(function(e){
			...
			var wrapfirst = '<div class="popbox-cast" style="display:none;height:100%; width: 100%; position:absolute; left: 0; top:0; background: rgba(0,0,0,0.4); z-index: 9990;"></div><div class="popbox-popup" style="visibility:hidden;'+setStyle+'"><a class="popbox-close">'+closeText+'</a>';
			var wraplast = '</div>';
